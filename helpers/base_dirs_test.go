...
func TestGetStateDirectoryWithEnv(t *testing.T) {
	var previousEnv string
	if v, isSet := os.LookupEnv("FLY_CONFIG_DIR"); isSet {
		previousEnv = v
	}
...
func TestGetStateDirectoryDefault(t *testing.T) {
	var previousEnv string
	if v, isSet := os.LookupEnv("FLY_CONFIG_DIR"); isSet {
		previousEnv = v
	}
...
func TestGetRuntimeDirectoryWithEnv(t *testing.T) {
	var previousEnv string
	if v, isSet := os.LookupEnv("FLY_CONFIG_DIR"); isSet {
		previousEnv = v
	}
...
func TestGetRuntimeDirectoryDefault(t *testing.T) {
	var previousEnv string
	if v, isSet := os.LookupEnv("FLY_CONFIG_DIR"); isSet {
		previousEnv = v
	}
