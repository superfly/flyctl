...
func TestDeploy(t *testing.T) {
	...
	t.Run("no blue machines", func(t *testing.T) {
	...
	t.Run("no new machines", func(t *testing.T) {
	...
	t.Run("replace 2 machines", func(t *testing.T) {
		flapsClient.breakLaunch = false
		strategy := newBlueGreenStrategy(flapsClient, 4)
...
func FuzzDeploy(f *testing.F) {
	...
	f.Fuzz(func(t *testing.T, numberOfExistingMachines int, breakLaunch bool, breakWait bool, breakUncondon bool, breakSetMetadata bool) {
		...
		flapsClient.breakUncordon = breakUncondon
