...
// 	mpgcmd "github.com/superfly/flyctl/internal/command/mpg/v1"
...
// // Test NewMPGService returns error when mpgv1 client is nil
// func TestNewMPGService_NilClient(t *testing.T) {
// 	ctx := context.Background()

// 	// Test with nil mpgv1 client in context
// 	service, err := NewMPGService(ctx)
// 	assert.Error(t, err)
// 	assert.Nil(t, service)
// 	assert.Contains(t, err.Error(), "mpgv1 client not found in context")
// }
...
// 	// Mock mpgv1 client that returns some backups
// 	mockUiex := &mock.UiexClient{
...
// 	for _, tt := range tests {
// 		t.Run(tt.name, func(t *testing.T) {
// 			params := &mpgcmd.CreateClusterParams{
// 				Name:           "test-db",
// 				OrgSlug:        "test-org",
// 				Region:         "ord",
// 				Plan:           "basic",
...
// 	for _, tt := range tests {
// 		t.Run(tt.name, func(t *testing.T) {
// 			result := mpgcmd.FormatAttachedApps(tt.apps)
...
// 	formattedApps := mpgcmd.FormatAttachedApps(clusters.Data[0].AttachedApps)
...
// 	formattedApps = mpgcmd.FormatAttachedApps(clusters.Data[1].AttachedApps)
