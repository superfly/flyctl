...
func confirmVolumeCreate(ctx context.Context, appName string) (bool, error) {
	...
	const msg = "Warning! Every volume is pinned to a specific physical host. You should create two or more volumes per application to avoid downtime and permanent data loss. Learn more at https://fly.io/docs/reference/volumes/"
