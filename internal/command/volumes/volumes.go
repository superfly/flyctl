...
func renderTable(ctx context.Context, volumes []fly.Volume, app *fly.AppCompact, out io.Writer, showHostStatus bool) error {
...
func selectVolume(ctx context.Context, flapsClient *flaps.Client, app *fly.AppCompact) (*fly.Volume, error) {
