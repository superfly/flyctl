...
// TosAgreementExistsResponse is returned by TosAgreementExists on success.
type TosAgreementExistsResponse struct {
	// Check if an extension ToS agreement exists
	TosAgreementExists bool `json:"tosAgreementExists"`
}

// GetTosAgreementExists returns TosAgreementExistsResponse.TosAgreementExists, and is useful for accessing the field via an interface.
func (v *TosAgreementExistsResponse) GetTosAgreementExists() bool { return v.TosAgreementExists }
...
// __TosAgreementExistsInput is used internally by genqlient
type __TosAgreementExistsInput struct {
	AddOnProviderName string `json:"addOnProviderName"`
	OrganizationId    string `json:"organizationId"`
}

// GetAddOnProviderName returns __TosAgreementExistsInput.AddOnProviderName, and is useful for accessing the field via an interface.
func (v *__TosAgreementExistsInput) GetAddOnProviderName() string { return v.AddOnProviderName }

// GetOrganizationId returns __TosAgreementExistsInput.OrganizationId, and is useful for accessing the field via an interface.
func (v *__TosAgreementExistsInput) GetOrganizationId() string { return v.OrganizationId }
...
func TosAgreementExists(
	ctx context.Context,
	client graphql.Client,
	addOnProviderName string,
	organizationId string,
) (*TosAgreementExistsResponse, error) {
	req := &graphql.Request{
		OpName: "TosAgreementExists",
		Query: `
query TosAgreementExists ($addOnProviderName: String!, $organizationId: ID!) {
	tosAgreementExists(addOnProviderName: $addOnProviderName, organizationId: $organizationId)
}
`,
		Variables: &__TosAgreementExistsInput{
	...
	var data TosAgreementExistsResponse
	resp := &graphql.Response{Data: &data}
