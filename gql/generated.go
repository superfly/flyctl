...
type DeleteAddOnDeleteAddOnDeleteAddOnPayload struct {
	AddOn DeleteAddOnDeleteAddOnDeleteAddOnPayloadAddOn `json:"addOn"`
}

// GetAddOn returns DeleteAddOnDeleteAddOnDeleteAddOnPayload.AddOn, and is useful for accessing the field via an interface.
func (v *DeleteAddOnDeleteAddOnDeleteAddOnPayload) GetAddOn() DeleteAddOnDeleteAddOnDeleteAddOnPayloadAddOn {
	return v.AddOn
}

// DeleteAddOnDeleteAddOnDeleteAddOnPayloadAddOn includes the requested fields of the GraphQL type AddOn.
type DeleteAddOnDeleteAddOnDeleteAddOnPayloadAddOn struct {
	Id string `json:"id"`
}

// GetId returns DeleteAddOnDeleteAddOnDeleteAddOnPayloadAddOn.Id, and is useful for accessing the field via an interface.
func (v *DeleteAddOnDeleteAddOnDeleteAddOnPayloadAddOn) GetId() string { return v.Id }
