...
[releases.latest]
usage="latest"
shortHelp="Show details for latest release"
longHelp="""Show details of the most recent release.
"""
[releases.show]
usage="show [VERSION]"
shortHelp="Show details for a specific release"
longHelp="""Shw the release details for a specific release. A version parameter identifies which release is required.
