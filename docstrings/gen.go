...
func Get(key string) KeyStrings {
	...
	case "agent":
		return KeyStrings{
			"agent <command>", "Commands that manage the Fly agent",
			`Commands that manage the Fly agent`,
		}
	case "agent.daemon-start":
		return KeyStrings{
			"daemon-start", "Run the Fly agent as a service (manually)",
...
create the application image when it is deployed.`,
	...
	case "apps.destroy":
		return KeyStrings{
			"destroy [APPNAME]", "Permanently destroys an app",
...
be shown with its name, owner and when it was last deployed.`,
	...
	case "apps.move":
		return KeyStrings{
			"move [APPNAME]", "Move an app to another organization",
...
organization the current user belongs to.`,
	...
	case "apps.resume":
		return KeyStrings{
			"resume [APPNAME]", "Resume an application",
...
the number of configured instances.`,
	...
	case "apps.suspend":
		return KeyStrings{
			"suspend [APPNAME]", "Suspend an application",
...
descriptions.`,
	...
	case "builtins.show":
		return KeyStrings{
			"show [<builtin name>]", "Show details of a builtin's configuration",
...
Takes hostname as a parameter to locate the certificate.`,
	...
	case "checks.handlers":
		return KeyStrings{
			"handlers", "Manage health check handlers",
			`Manage health check handlers`,
		}
	case "checks.handlers.create":
		return KeyStrings{
			"create", "Create a health check handler",
			`Create a health check handler`,
		}
	case "checks.handlers.delete":
		return KeyStrings{
			"delete <organization> <handler-name>", "Delete a health check handler",
			`Delete a health check handler`,
		}
	case "checks.handlers.list":
		return KeyStrings{
			"list", "List health check handlers",
			`List health check handlers`,
		}
	case "checks.list":
		return KeyStrings{
			"list", "List app health checks",
...
retrieved from the Fly service and saved in TOML format.`,
	...
	case "curl":
		return KeyStrings{
			"curl <url>", "Run a performance test against a url",
	...
	case "deploy":
		return KeyStrings{
			"deploy [<workingdirectory>]", "Deploy an app to the Fly platform",
...
browser to view the content.`,
	...
	case "domains.add":
		return KeyStrings{
			"add [org] [name]", "Add a domain",
			`Add a domain to an organization`,
		}
	case "domains.list":
		return KeyStrings{
			"list [<org>]", "List domains",
			`List domains for an organization`,
		}
	case "domains.register":
		return KeyStrings{
			"register [org] [name]", "Register a domain",
...
Fly network`,
	...
	case "ips.release":
		return KeyStrings{
			"release [ADDRESS]", "Release an IP address",
...
The orgs command lists all the organizations you are a member of.`,
	...
	case "list.apps":
		return KeyStrings{
			"apps [text] [-o org] [-s status]", "Lists all your apps",
...
to all instances running in a specific region using the --region/-r flag.`,
	...
	case "machine":
		return KeyStrings{
			"machine <command>", "Commands that manage machines",
			`Commands that manage machines`,
		}
	case "machine.clone":
		return KeyStrings{
			"clone", "Clones a Fly Machine",
			`Clones a Fly Machine`,
		}
	case "machine.kill":
		return KeyStrings{
			"kill <id>", "Kill (SIGKILL) a Fly machine",
	...
	case "machine.remove":
		return KeyStrings{
			"remove <id>", "Remove a Fly machine",
			`Remove a Fly machine`,
		}
	case "machine.run":
		return KeyStrings{
			"run <image> [command]", "Launch a Fly machine",
			`Launch Fly machine with the provided image and command`,
		}
	case "machine.start":
		return KeyStrings{
			"start <id>", "Start a Fly machine",
			`Start a Fly machine`,
		}
	case "machine.status":
		return KeyStrings{
			"status <id>", "Show current status of a running machine",
			`Show current status of a running machine`,
		}
	case "machine.stop":
		return KeyStrings{
			"stop <id>", "Stop a Fly machine",
			`Stop a Fly machine`,
		}
	case "monitor":
		return KeyStrings{
...
organization the current user belongs to.`,
	...
	case "open":
		return KeyStrings{
			"open [PATH]", "Open browser to current deployed application",
...
organization later.`,
	...
	case "orgs.invite":
		return KeyStrings{
			"invite <org> <email>", "Invite user (by email) to organization",
...
about the Fly platform.`,
	...
	case "postgres.db.create":
		return KeyStrings{
			"create <postgres-cluster-name>", "create a database in a cluster",
			`create a database in a cluster`,
		}
	case "postgres.db.list":
		return KeyStrings{
			"list <postgres-cluster-name>", "list databases in a cluster",
	...
	case "postgres.users.create":
		return KeyStrings{
			"create <postgres-cluster-name>", "create a user in a cluster",
			`create a user in a cluster`,
		}
	case "postgres.users.list":
		return KeyStrings{
			"list <postgres-cluster-name>", "list users in a cluster",
			`list users in a cluster`,
		}
	case "proxy":
		return KeyStrings{
			"proxy <local:remote>", "Proxies connections to a fly app",
	...
	case "regions.add":
		return KeyStrings{
			"add REGION ...", "Allow the app to run in the provided regions",
			`Allow the app to run in one or more regions`,
		}
	case "regions.backup":
		return KeyStrings{
			"backup REGION ...", "Sets the backup region pool with provided regions",
	...
	case "regions.remove":
		return KeyStrings{
			"remove REGION ...", "Prevent the app from running in the provided regions",
			`Prevent the app from running in the provided regions`,
		}
	case "regions.set":
		return KeyStrings{
			"set REGION ...", "Sets the region pool with provided regions",
...
the number of configured instances.`,
	...
	case "scale.count":
		return KeyStrings{
			"count <count>", "Change an app's VM count to the given value",
...
For pricing, see https://fly.io/docs/about/pricing/`,
	...
	case "scale.vm":
		return KeyStrings{
			"vm [SIZENAME] [flags]", "Change an app's VM to a named size (eg. shared-cpu-1x, dedicated-cpu-1x, dedicated-cpu-2x...)",
...
the application and vm environment.`,
	...
	case "secrets.import":
		return KeyStrings{
			"import [flags]", "Read secrets in name=value from stdin",
...
The actual value of the secret is only available to the application.`,
	...
	case "secrets.set":
		return KeyStrings{
			"set [flags] NAME=VALUE NAME=VALUE ...", "Set one or more encrypted secrets for an app",
...
Any value that equals "-" will be assigned from STDIN instead of args.`,
	...
	case "secrets.unset":
		return KeyStrings{
			"unset [flags] NAME NAME ...", "Remove encrypted secrets from an app",
			`Remove encrypted secrets from the application. Unsetting a
secret removes its availability to the application.`,
		}
	case "ssh":
		return KeyStrings{
			"ssh <command>", "Commands that manage SSH credentials",
			`Commands that manage SSH credentials`,
		}
	case "ssh.console":
		return KeyStrings{
			"console [<host>]", "Connect to a running instance of the current app.",
			`Connect to a running instance of the current app; with -select, choose instance from list.`,
		}
	case "ssh.establish":
		return KeyStrings{
			"establish [<org>] [<override>]", "Create a root SSH certificate for your organization",
...
invalidated.`,
	...
	case "ssh.issue":
		return KeyStrings{
			"issue [org] [email] [path]", "Issue a new SSH credential.",
...
validity.`,
	...
	case "ssh.shell":
		return KeyStrings{
			"shell [org] [address]", "Connect directly to an instance.",
...
currently allocated.`,
	...
	case "status.instance":
		return KeyStrings{
			"instance [instance-id]", "Show instance status",
			`Show the instance's current status including logs, checks,
and events.`,
		}
	case "turboku":
		return KeyStrings{
			"turboku <heroku-app>", "Launches heroku apps",
...
command to update the application.`,
	...
	case "volumes":
		return KeyStrings{
			"volumes <command>", "Volume management commands",
			`Commands for managing Fly Volumes associated with an application.`,
		}
	case "volumes.create":
		return KeyStrings{
			"create <volumename>", "Create new volume for app",
...
sets the size as the number of gigabytes the volume will consume.`,
	...
	case "volumes.delete":
		return KeyStrings{
			"delete <id>", "Delete a volume from the app",
...
number to operate. This can be found through the volumes list command`,
	...
	case "volumes.show":
		return KeyStrings{
			"show <id>", "Show details of an app's volume",
